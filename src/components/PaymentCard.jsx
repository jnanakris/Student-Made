...
function PaymentCard({ 
	...
	return (
		<div className="bg-white p-6 rounded-lg shadow mb-4 border">
			<div className="flex items-center justify-between mb-4">
				<h3 className="text-lg font-semibold">Card #{index}</h3>
					...
					<div className="flex justify-end mt-4">
						{initialData && (
							<button
								...
								className="px-4 py-2 border rounded text-gray-600 mr-2"
							>
								Cancel
							</button>
						)}
				...
				<div className="space-y-3">
					<div className="flex items-center justify-between">
						<div className="flex items-center">
							<svg className="h-8 w-8 mr-2 text-gray-500" viewBox="0 0 24 24" fill="currentColor">
								<path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
							</svg>
							<span className="font-medium">{formatCardNumber(cardData.cardNumber)}</span>
						</div>
						<div>
							{isDefault ? (
